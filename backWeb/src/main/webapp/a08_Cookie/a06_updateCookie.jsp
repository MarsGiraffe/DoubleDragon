...
3. encoding : 설정 부분 처리
	import java.net.URLEncoder
	new Cookie(URLEncoder("키","utf-8"),"값")
...
<%
	// 변경
	Cookie upt = new Cookie("fruit","바나나");
	response.addCookie(upt);
	// 추가
	// import="java.net.URLEncoder"
	Cookie ins = new Cookie(
			URLEncoder.encode("과일","utf-8"),"망고");
			
	response.addCookie(ins);
	
	response.addCookie(new Cookie("c1","8000"));
...
<body>
    <div class="container mt-3">
       <h3>쿠키 예제</h3>
       <h4 onclick="location.href='a02_showCookie.jsp'">쿠키 확인</h4>
