...
<%--
#	쿠키의 수정
1. 쿠키값이 없는 key를 addCookie하면 등록이 되고,
2. 값이 있는 쿠키의 key를 다른 값으로 addCookie하면 수정이 된다.
 --%>
<%
	Cookie upt = new Cookie("price","4500");
	response.addCookie(upt);
	Cookie ins = new Cookie("cnt","4");
	response.addCookie(ins);
	// ex) a06_updateCookie.jsp
	// 			cnt는 5로 변경, pname은 apple로 추가
	//			a02_showCookie 에서 확인할 수 있도록 처리..
%>
    <div class="container mt-3">
       <h3>쿠키의 수정과 등록</h3>
       <h4 onclick="location.href='a02_showCookie.jsp'">쿠키 확인하러 가기</h4>
