...
: 웹 서버와 연동된 프로젝트명으로 default webapp 위치를 잡아준다.
...
<head>
    ...
    <script type="text/javascript">
		...
		1. $("선택자")
			단일 선택으로 처리할 수 있고,
			동일한 태그에 모든 기능을 처리할 때도
			for문 없이도 가능하다.
			$("h1").text("일괄변경")
			h1이 여러 개 있더라도 한꺼번에 모두 다 label을
			일괄 변경이 가능하다.
...
<body>
    <div class="container mt-3">
    	...
    	<h3>기본경로:${path}</h3>
    	<h3>기본경로:${path}</h3>
    	<%-- /backendWeb/z01_upload/img01.png --%>
    	<img src="${path}/z01_upload/logo.png">
