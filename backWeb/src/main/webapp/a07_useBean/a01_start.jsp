...
4. 요청값 처리 기능
	...
	요청값과 저장하는 메서드이름이 다를 떄, 요청값 이름으로 property를 
	연동할 때, param을 활용한다.
	<jsp:setProperty name="p01" property="age"
		param="age77"/>
	==> 요청값이 query string으로 있을 때, 저장된다.
	p01.setName("홍길동")
	p01.setAge(25)
	p01.setAge("25")
	...
	querystring이 property와 동일한 이름과 할당 가능한 type으로 
	선언되어 있으면 자동으로 모두 다 할당한다.
	ex1)
