...
3. 수정 요청값을 받아서 수정되는 Servlet controller	
	...
	4) json 데이터 출력
4. 수정 버튼 클릭 
	1) 화면단에 수정데이터 입력 후, 버튼 클릭 시 ajax 호출
...
<script type="text/javascript">
	...
	function detail(no){
		...
		// /backendWeb/codeDetail.do?no=1011
